...
export const CSSColorParserTable: TransitionTable = {
  // State: Initial (Waiting for a new color to begin)
  [ParserState.Initial]: {
  ...
  // State: AwaitLeftParen (Just saw 'rgb', expecting '(')
  ...
  // State: AwaitArgument (Inside a function, expecting a value or a closing paren)
  ...
  // State: AwaitSeparator (Just saw an argument, expecting a delimiter or closing paren)
  [ParserState.AwaitSeparator]: {
    ...
    // Implicit space separator: if we get another argument, we transition back
    [TokenType.NUMBER]: {
      action: actions.createAndPushArgument,
